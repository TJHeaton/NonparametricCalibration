# 5th April 2022
# Single normal cluster examples
# set.seed(43) is the value used for the paper
...
# Assuming a true underlying density of 1 clusters (with some arbitrary weights)
...
save.image("SimOutput/WalkerandNealSimStudySingleCluster_Revisedv1AdaptiveSeed43.RData")
